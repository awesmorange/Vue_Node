<template>
    <div class="tabledata" data-app="true">
        ...
        &lt;!&ndash;test treeview&ndash;&gt;
        &lt;!&ndash;获取选中的值；通过v-model绑定值，wactch观察者监测值的变化在其中调用method-里面的方法&ndash;&gt;
        <div>
            <v-treeview
                    v-model="selection"
                    selectable
        ...
        <v-data-table
                ...
                :options.sync="options"
                :server-items-length="totalDesserts"
                :items-per-page-items="[20, 50, { text: 'All', value: -1 }]"
                sort-by="calories"
                class="elevation-1"
        >
            <template v-slot:top>
...
<script>
    export default {
        ...
        data: () => ({
            ...
            footerProps: {'items-per-page-options': [10,20, 50, { text: 'All', value: -1 }]},
